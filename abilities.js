exports.BattleAbilities = {
  ...
  disguise: {
    ...
    shortDesc:
      '(Mimikyu only) The first hit it takes is blocked.'
  },
  download: {
    flags: {},
    name: 'Download',
  ...
  moody: {
    ...
    shortDesc:
      'Boosts a random stat +2 and another stat -1 every turn.'
  },
  motordrive: {
    flags: { breakable: 1 },
    name: 'Motor Drive',
  ...
  synchronize: {
    ...
    rating: 2,
    num: 28,
    desc: 'If another Pokemon burns, paralyzes, poisons, or badly poisons this Pokemon, that Pokemon receives the same non-volatile status condition. Leading with a Pokémon with this ability gives you a 50% chance to force their nature on a wild encounter.',
    shortDesc:
